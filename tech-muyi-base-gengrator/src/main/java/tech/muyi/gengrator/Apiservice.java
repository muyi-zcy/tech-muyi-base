        ...
        FastAutoGenerator.create(url,username, password)
                .globalConfig(builder -> {
                    builder.fileOverride()
                            .author(System.getProperty("user.name")) // 设置作者
                ...
                .templateConfig(builder -> {
                    builder.service("templates/ApiService")
                            .disable(TemplateType.ENTITY,TemplateType.MAPPER,TemplateType.CONTROLLER,TemplateType.SERVICEIMPL,TemplateType.XML,TemplateType.MAPPER);
                })
                .strategyConfig(builder -> {
                    builder.addInclude(tableName) // 设置需要生成的表名
                            .addTablePrefix("t_", "c_")
                            .serviceBuilder()
                            .formatServiceFileName("%sApiService")
                            .build(); // 设置过滤表前缀
                })
